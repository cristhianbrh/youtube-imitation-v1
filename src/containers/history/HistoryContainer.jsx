...
export const HistoryContainer = () => {
    return (
        <div className="HistoryContainer">
            ...
            <p>Haz un seguimiento de lo que miras</p>
            <p>Debes acceder a tu cuenta para ver el historial de reproducciones. <a href="https://support.google.com/youtube/answer/95725?hl=es-419" target="_blank">Más información</a> </p>
            <button>
